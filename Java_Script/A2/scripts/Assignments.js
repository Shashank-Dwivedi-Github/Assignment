...
/*function greetPerson(name: string){
    if(name === "Shashank"){
        var greet = "Hello Shashank"
    }else{
        var greet = "Hi There"
    }
    console.log(greet);
}
greetPerson("Shashank");*/
...
//Q 4
var arr = ["Shashank", "rahul", "ram", "shyam", "anuj"];
...
var A1 = new CurrentAccount(101, 'Shashank', 100, 10);
var A2 = new CurrentAccount(101, 'rahul', 200, 5);
var A3 = new SavingAccount(101, 'ram', 150, 3);
var A4 = new SavingAccount(101, 'shyam', 250, 7);
console.log(A1);
